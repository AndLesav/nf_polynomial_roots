...
# This file was *autogenerated* from the file /home/alesavou/Documents/Projects/roots-crt/online-pre/scripts/cf_roots_twphs_saturation_bad_nfroots.sage
from sage.all_cmdline import *   # import sage library

_sage_const_123457 = Integer(123457); _sage_const_10 = Integer(10); _sage_const_1 = Integer(1); _sage_const_60 = Integer(60); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_7 = Integer(7); _sage_const_300 = Integer(300); _sage_const_4 = Integer(4); _sage_const_200 = Integer(200); _sage_const_0 = Integer(0); _sage_const_5000 = Integer(5000); _sage_const_1000 = Integer(1000)#!/usr/bin/env sage
from sage import *
...
# data file
str_file = '../data/cf_twphs_stickel_saturation_bad_' + type_prime + '_' + str(size_primes) + '_nfroots'

d = _sage_const_2 ; # d = ? orbits 

for m in range(_sage_const_7 , _sage_const_300 ):
    ...
    s_pari=[];
    t_pari = _sage_const_0 ;
    for i in range(H.nrows()):
        print("Sol {}".format(i));

        print("using nfroots")
        # global X, Y
        Zxy = PolynomialRing(QQ, _sage_const_2 , 'x, y');
        ...
        res = K(pari.liftall(res[_sage_const_0 ])); t = cputime(t);
        t_pari += t;
        
        print("\tTime Root: {:.4f}s".format(t));
        s_pari.append(res);
        # Check
        ls_pari = logarg_set(s_pari[-_sage_const_1 ], phi);
        ...
        assert(fp.fp_assert_equal("", ls_pari.inf, s[i].inf, target=_sage_const_1000 ));
        assert(fp.fp_assert_zero("", [min(_th.abs(), _sage_const_1 -_th.abs()) for _th in logarg_reduce_args(er*ls_pari.args) - logarg_reduce_args(er*s[i].args)], target=_sage_const_1000 ));
