...
sage ${EXE_DIR}/cf_roots_tw_sti_bad_cc_embeddings.sage "max" ${size_prime}  1>${LOGS_DIR}/tw_sti_bad_max_${size_prime}_cc 2>&1 &

# sage ${EXE_DIR}/cf_roots_tw_sti_bad_bel.sage "max" ${size_prime}  1>${LOGS_DIR}/tw_sti_bad_max_${size_prime}_bel 2>&1 &
